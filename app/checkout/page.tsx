...
> = {
    pro: {
        ...
        variantUrl:
            ...
            "https://vextor.lemonsqueezy.com/checkout/buy/YOUR_PRO_VARIANT",
    },
    teams: {
        name: "Teams Plan",
        price: "$480",
        ...
        variantUrl:
            ...
            "https://vextor.lemonsqueezy.com/checkout/buy/YOUR_TEAMS_VARIANT",
    },
};
...
function CheckoutContent() {
    ...
    useEffect(() => {
        ...
        script.onload = () => {
            // @ts-expect-error Lemon Squeezy global
    ...
    const handleProceedToPayment = () => {
        ...
        params.set("custom[user_id]", user.id);
        params.set("checkout[email]", user.email);

        const separator = plan.variantUrl.includes("?") ? "&" : "?";
        const finalUrl = `${plan.variantUrl}${separator}${params.toString()}`;
    ...
    return (
        <div className="max-w-3xl mx-auto py-20 px-6">
            ...
            <p className="text-neutral-500 text-sm mb-8">
                Confirm your account and subscription details before checkout.
            </p>
            ...
            <div className="flex items-center justify-center gap-2 mt-8 text-xs text-neutral-500">
                ...
                <span>
                    Encrypted 256-bit checkout powered by Lemon Squeezy
                </span>
            </div>
        </div>
    );
