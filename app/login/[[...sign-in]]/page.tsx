...
export default function LoginPage() {
  ...
  const handleSignup = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Clerk requires the email to be verified before the account is created
      ...
      // Route field-specific Clerk errors (e.g. pwned/compromised password,
      // duplicate email) under the relevant input instead of a generic banner.
      if (
        clerkError?.code === "form_password_pwned" ||
        clerkError?.meta?.paramName === "password"
      ) {
  ...
  return (
    <main
      className={`relative min-h-screen overflow-hidden bg-[#0B0F17] transition-all duration-700 ease-out
      ${mounted
    ...
    >
      ...
      <div
        className="absolute bottom-32 right-32 h-52 w-52 animate-pulse rounded-full bg-violet-500/20 blur-[120px]"
        style={{
      ...
      <div
        className="absolute left-1/2 top-1/2 h-32 w-32 animate-pulse rounded-full bg-cyan-400/20 blur-[90px]"
        style={{
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-2xl shadow-[0_0_60px_rgba(59,130,246,0.15)]">
            ...
            <p className="mt-2 text-gray-400 transition-all duration-300">
              {pendingVerification
                ...
                : isSignup
                  ? "Create your Vextor AI account."
                  : "Sign in to continue building with Vextor AI."}
            </p>
                ...
                <>
                  ...
                  >
                    ...
                    >
                      <path
                        fill="#FFC107"
                        d="M43.6 20H42V20H24v8h11.3C33.7 32.7 29.3 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3 0 5.7 1.1 7.8 2.9l5.7-5.7C34.1 6.1 29.3 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20 20-8.9 20-20c0-1.3-.1-2.7-.4-4z"
                      />
                      <path
                        fill="#FF3D00"
                        d="M6.3 14.7l6.6 4.8C14.7 15.3 19 12 24 12c3 0 5.7 1.1 7.8 2.9l5.7-5.7C34.1 6.1 29.3 4 24 4 16.3 4 9.7 8.3 6.3 14.7z"
                      />
                      <path
                        fill="#4CAF50"
                        d="M24 44c5.2 0 10-2 13.6-5.2l-6.3-5.2C29.3 35.7 26.8 36 24 36c-5.3 0-9.7-3.3-11.3-8l-6.6 5.1C9.5 39.5 16.2 44 24 44z"
                      />
                      <path
                        fill="#1976D2"
                        d="M43.6 20H42V20H24v8h11.3c-1.1 3.2-3.4 5.7-6.6 7.2l6.3 5.2C39.6 36.8 44 31 44 24c0-1.3-.1-2.7-.4-4z"
                      />
                    </svg>
                  ...
                  {isSignup && (
                    ...
                    >
                      ...
                      <input
                        ...
                        className={`h-12 w-full rounded-xl border bg-white/5 px-4 text-white outline-none transition focus:ring-2 ${
                          fieldErrors.name
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`h-12 w-full rounded-xl border bg-white/5 px-4 text-white outline-none
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`h-12 w-full rounded-xl border bg-white/5 px-4 pr-12 text-white outline-none
                        placeholder:text-gray-500
                        transition
                        focus:ring-2 ${
                      ...
                      <button
                        ...
                        className="absolute right-4 top-1/2 cursor-pointer -translate-y-1/2 text-gray-400 hover:text-white"
                        title={showPassword ? "Hide Password" : "Show Password"}
                      >
                        {showPassword ? <RiEyeCloseLine /> : <PiEye />}
                      </button>
                      ...
                      >
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            placeholder="••••••••"
                            className={`h-12 w-full rounded-xl border bg-white/5 px-4 pr-12 text-white outline-none transition focus:ring-2 ${
                          ...
                          >
                            {showConfirmPassword ? <RiEyeCloseLine /> : <PiEye />}
                          </button>
                  ...
                  {/* Clerk Smart CAPTCHA mount point (required for bot protection on custom sign-up flows) */}
              ...
              {pendingVerification && (
                <div className="overflow-hidden transition-all duration-300 animate-in fade-in slide-in-from-top-2">
                  ...
                  <input
                    ...
                    inputMode="numeric"
                    maxLength={6}
                    className={`h-12 w-full rounded-xl border bg-white/5 px-4 text-white tracking-[0.4em] outline-none transition focus:ring-2 ${
                      fieldErrors.code
                        ? "border-red-500/60 focus:border-red-500 focus:ring-red-500/20"
                        : "border-white/10 focus:border-blue-500 focus:ring-blue-500/20"
                    }`}
                  ...
                  {fieldErrors.code && (
                    <p className="mt-1.5 text-xs text-red-400">{fieldErrors.code}</p>
                  )}
