      ...
      <header className="container mx-auto h-full min-h-screen flex flex-col justify-center items-center relative z-[99999]">
        ...
        <div className="relative text-center">
          <div className="relative z-20 place-items-center">
            ...
            <h1 className={`text-[80px] font-[900] ${isDarkMode ? "text-white" : "text-black"}`}>Vextor AI Code Editor</h1>
            ...
            <h4 className={`uppercase text-[25px] ${isDarkMode ? "text-white" : "text-black"} relative -top-1 tracking-[4px]`}>Shift your coding direction</h4>
            <button className="flex gap-2 items-center bg-gradient-to-r from-[#3185ff] to-[#bc5bf9] py-3 px-7 rounded-lg bg-left hover:bg-right bg-[length:200%_100%] text-xl cursor-pointer text-white mt-7 center_btn" title="Download Vextor for Windows">
              <FaWindows />
