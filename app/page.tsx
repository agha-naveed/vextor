      ...
      <header className="container mx-auto h-full min-h-screen flex flex-col justify-center items-center relative z-[99999]">
        ...
        <div className="relative text-center">
          <div className="relative z-20">
            ...
            <Image src={flare} alt="flare" loading="lazy" className={`absolute -top-80 -right-90 ${isDarkMode ? "animate-flare-fade" : "animate-dark-flare-fade"} w-full h-auto select-none z-0 outline-none`} />
